...
const AdminDashboard = () => {
  ...
  const [userList, setUserList] = useState([
    {
      username: "Bhavani",
      email: "bhavani@varundigitalmedia.com",
      role: "User",
      status: "Active",
    ...
    {
      username: "Pavan",
      email: "pavan@varundigitalmedia.com",
      role: "User",
      status: "Inactive",
    ...
    {
      username: "Deepika",
      email: "deepika@varundigitalmedia.com",
      role: "User",
      status: "active",
      createDate: "2025-01-01",
      password: "password456",
    ...
    {
      username: "Giri",
      email: "giri@varundigitalmedia.com",
      role: "User",
      status: "active",
      createDate: "2025-01-01",
      password: "password456",
  ...
  const [jobTitlesData1, setJobTitlesData1] = useState([{
    id: '1',
    value: 'Received',
    description: 'This is Received value',
    type: 'System', // Ensure this matches one of your type options
  },
  ...
  },
  {
    ...
    type: 'User', // Ensure this matches one of your type options
  },
  {
    id: '6',
    value: 'Rejected',
...
`, // Default content
  ...
  const [profileData, setProfileData] = useState({
    ...
    linkedContact: "Recruiter",
    profilePicture:
      "https://bharatpayroll.s3.amazonaws.com/public/pss_bharatpayroll_db/employee_images/1703243628672.jpg",
  })
                ...
                <div className="row lookup-cust pipeline-acc">
                  <div className="col-6">
                    <Accordion
                      ...
                      style={{ width: "100%" }}
                    >
                      <AccordionTab header="Pipeline Status">
                        <div>
                  ...
                  <div className="col-6">
                    <Accordion multiple={false} style={{ width: "100%" }}>

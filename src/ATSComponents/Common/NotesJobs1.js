...
const NotesJobs = () => {
    ...
    const [jobs] = useState([
        { id: 'Job-101', title: 'Web Developer', },
        { id: 'Job-102', title: 'Graphic Designer', },
        { id: 'Job-103', title: 'Project Manager', },
        { id: 'Job-104', title: 'Jr. Graphic Designer', },
        { id: 'Job-105', title: 'HR Specialist', },
    ]);
    ...
    return (
        <React.Fragment>
            <Tooltip target=".import" content="Job Notes" position="bottom" style={{ marginTop: "5px" }} />

...
const NotesJobs = () => {
    ...
    const [jobs] = useState([
        { id: 'J001', title: 'Software Engineer', company: 'PSS' },
        { id: 'J002', title: 'Data Analyst', company: 'Varun Digital'},
        { id: 'J003', title: 'Data Analyst', company: 'TCS' },
        { id: 'J004', title: 'Marketing Specialist', company: 'L&T'},
        { id: 'J005', title: 'UI/UX Designer', company: 'Infosys'},
    ]);
    ...
    return (
        <React.Fragment>
            ...
            <Dialog header={`NOTE - Job-101, Web Developer`} visible={visibleLinkJob} onHide={() => setVisibleLinkJob(false)}
                        ...
                        <div className="field">
                            ...
                            <div className="d-flex align-items-center" style={{ position: 'relative' }}>
                                <InputText
                                    ...
                                    placeholder="Job-101, Web Developer"
                                    className="w-full"

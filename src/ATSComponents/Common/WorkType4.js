...
const WorkType4 = ({ initialWorkTypes: propInitialWorkTypes, dropdownWorkTypes: propDropdownWorkTypes } = {}) => {
...
//     });
    ...
    const dropdownWorkTypes = propDropdownWorkTypes || [
        ...workTypes,
        { id: 'divider', disabled: true },
        { name: 'Add Project Name', id: 'create-new-work-type' },
        { name: 'Edit Project Name', id: 'edit-selected-work-type' }
    ];
